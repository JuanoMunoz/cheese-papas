  ...
  return (
    <section>
      ...
      <div className="grid p-10 grid-rows-6 grid-cols-3 gap-4 h-[700px]">
        <div className="rounded-lg hover:scale-95 transition-all duration-300 lg:grayscale-100 cursor-pointer hover:grayscale-0 bg-[url(/grid1.webp)] bg-cover row-span-4 col-span-1 flex items-center justify-center text-white font-bold text-lg"></div>
        ...
        <div className="rounded-lg hover:scale-95 transition-all duration-300 lg:grayscale-100 cursor-pointer hover:grayscale-0 bg-[url(test.png)] bg-[length:100%_100%] row-span-2 col-span-1 flex items-center justify-center text-white font-bold"></div>
